...
export default function BookingDetails() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (bookingResponse.ok) {
            ...
            const bookingDetail = bookingsData.find(
              (b) => b.id === parseInt(id)
            );
        ...
        console.log(
          "Failed to fetch booking with bids, falling back to regular fetch"
        );
      }
  ...
  const addStaticMarkers = useCallback(
    (map) => {
      ...
      // Add pickup marker
      geocoder.geocode(
        { address: booking.pickup_location + ", Dhaka, Bangladesh" },
        (results, status) => {
          if (status === "OK") {
      ...
      // Add dropoff marker
      geocoder.geocode(
        { address: booking.dropoff_location + ", Dhaka, Bangladesh" },
        (results, status) => {
          if (status === "OK") {
            new window.google.maps.Marker({
              position: results[0].geometry.location,
  ...
  const handleAcceptBid = async (bidId) => {
    try {
      ...
      const response = await fetch(
        `${apiBaseUrl}/api/bookings/bids/${bidId}/accept/`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          ...
          <div className="main-content">
            ...
            <div className="right-column">
                ...
                <div className="priority-section">
                  ...
                  {booking.bids && booking.bids.length > 0 ? (
                          ...
                          <div className="bid-header">
                            <div className="driver-info-bid">
                              ...
                              <div className="driver-details-bid">
                                <div className="driver-name-bid">
                                  {bid.driver_name}
                                </div>
                                <div className="driver-phone-bid">
                                  📞 {bid.driver_phone}
                                </div>
                              </div>
                            </div>
                    ...
                    <div className="no-bids-message">
                      ...
                      <h4>No bids yet</h4>
                      <p>
                        Your booking is visible to drivers. They will submit
                        bids soon!
                      </p>
                    </div>
                  )}
              ...
              {booking.status !== "pending" && getDriverInfo() && (
                <div className="priority-section">
                  <div className="priority-title">🚗 Your Driver</div>
            ...
            <div className="left-column">
              ...
              {booking.status === "pending" && (
                <div className="pending-message">
                  ...
                  <p>
                    ...
                    confirmation. We&apos;ll notify you once a driver accepts
                    your request.
                  </p>
                </div>
              )}
                ...
                <div className="detail-section">
                  ...
                  <div className="detail-item">
                    ...
                    <span className="detail-value">
                      {booking.patient_name || "Not specified"}
                    </span>
                  </div>
                  <div className="detail-item">
                    <span className="detail-label">Phone Number</span>
                    <span className="detail-value">
                      {booking.patient_phone || "Not specified"}
                    </span>
                  </div>
                </div>
              ...
              <div className="map-section">
                <div className="section-title">🗺️ Route Map</div>
